            ...
            <div className="p-6">
              <div className="flex">
                ...
                <div className="flex-1">
                  ...
                  <span className="inline-block px-2 py-1 bg-[#4096FF]/10 text-[#4096FF] text-xs rounded-full">
                    {achievement.category}
                  </span>
                  <p className="text-black mt-4 whitespace-pre-wrap">{achievement.description}</p>
                </div>
        ...
        return (
          <div className="rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  <span className="inline-block px-2 py-1 bg-[#4096FF]/10 text-[#4096FF] text-xs font-semibold rounded-full mb-2">
                    {achievement.category}
                  </span>
                  <h3 className="font-bold text-xl text-black">{achievement.title}</h3>
                  <p className="text-sm text-gray-500">
          ...
          <div>
            <div className="flex justify-between mb-3">
              <div>
                ...
                <span className="inline-block px-2 py-1 bg-[#4096FF]/10 text-[#4096FF] text-xs rounded mt-1">
                  {achievement.category}
                </span>
              </div>
            </div>
          ...
          <div className="flex justify-between mb-3">
            {!simplified && isOwner && (
              <div className="flex space-x-2 ml-auto mb-2">
                <span
                  onClick={() => setIsEditing(true)}
                  className="text-transparent bg-clip-text bg-gradient-to-r from-[#4096FF] to-[#12B981] cursor-pointer"
                  title="Edit"
                >
                  <span className="material-icons">edit</span>
                </span>
